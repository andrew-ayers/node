...
describe('Contact Service', () => {
	...
	describe('search', () => {
        // ALA: Added this test for the new method...
        describe('transformPhoneNumber', () => {
            it('should return properly transformed phone numbers for a variety of formats', async () => {
                expect(service.transformPhoneNumber("314-555-0000")).to.equal("3145550000");
                expect(service.transformPhoneNumber("314.555.0000")).to.equal("3145550000");
                expect(service.transformPhoneNumber("(303) 123-4567")).to.equal("3031234567");
                expect(service.transformPhoneNumber("(303)-123-4567")).to.equal("3031234567");
                expect(service.transformPhoneNumber("+1 (321) 213-7712")).to.equal("3212137712");
                expect(service.transformPhoneNumber("+1-321-213-7712")).to.equal("3212137712");
            });
        });
